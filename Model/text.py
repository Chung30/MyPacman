...
class Text(object):
    def __init__(self, text, color, x, y, size, time=None, id=None, visible=True):
        ...
        self.label = None
        self.destroy = False
        self.setupFont("asset/PressStart2P-Regular.ttf")
        self.createLabel()
...
class TextGroup(object):
    ...
    def setupText(self, STATE):
        ...
        if STATE == STATE1:
            ...
            self.alltext[SCORETXT2] = Text("0".zfill(8), WHITE, 20 * TILEWIDTH, TILEHEIGHT, size)
    ...
    def updateScore2(self, score):
        self.updateText(SCORETXT2, str(score).zfill(8))
